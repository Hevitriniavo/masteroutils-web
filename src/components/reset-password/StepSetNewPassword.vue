    ...
    <TheCard card-class="p-24 max-w-[650px] bg-white rounded-4xl">
      <div class="flex flex-col gap-4">
        ...
        >
          ...
          <template #iconRight>
            <eye v-if="showPassword" @click="showPassword = !showPassword" class="w-5 h-5 text-primary-blue" />
        ...
        >
          ...
          <template #iconRight>
            <eye v-if="showConfirmPassword" @click="showConfirmPassword = !showConfirmPassword" class="w-5 h-5 text-primary-blue" />
            <eye-off v-else @click="showConfirmPassword = !showConfirmPassword" class="w-5 h-5 text-primary-blue" />
          </template>
        </the-input>

        <the-button btn-class="w-full bg-dark-blue-text rounded-lg uppercase" @btn-click="handleSubmit">
          Valider
        </the-button>
      </div>
    </TheCard>
